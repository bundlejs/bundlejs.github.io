...
<img src="https://avatars0.githubusercontent.com/u/29328738?s=460&u=17ae71cd2247e72d793b9d79c19cf8bfb66d76cf&v=4" style="height: 50px; width: 50px; border-radius: 50%; margin-bottom: 15px;margin-right: auto;margin-left: auto" />

<img src="https://tridiamond.me/whoami/undraw_programming_2svr.svg" style="margin: 0 auto;width:550px" />

<div class="my-links">
  <a class="gradient-text" href="https://github.com/TriDiamond" target="_blank" rel="noopener"><span class=" iconfont icon-weibo"></span></a>
...
<style>
  .my-links {display: flex; align-content: center; margin-top: 30px;justify-content: center}
  .my-links a {display: flex; color: #000; padding: 2px 10px;border-bottom:none !important;}
  .my-links a span {font-size: 28px;}
  .my-links a span:after {height: 100px}
</style>
